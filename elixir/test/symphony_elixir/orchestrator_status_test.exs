defmodule SymphonyElixir.OrchestratorStatusTest do
  ...
  test "status dashboard renders jira project link in header" do
    ...
    assert rendered =~ "https://example.atlassian.net/jira/software/projects/BOT"
    refute rendered =~ "https://linear.app/project/BOT/issues"
  end
